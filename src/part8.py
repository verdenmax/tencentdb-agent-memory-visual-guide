...
<table class="t">
  ...
  <tr><td class="mono">migrate-sqlite-to-tcvdb --dry-run</td><td>评估从本地 SQLite 到 Tencent VectorDB 的迁移。</td><td><span class="inline">--plugin-data-dir</span> 与 <span class="inline">--openclaw-config-path</span>（必填）、TCVDB 连接 flag <span class="inline">--tcvdb-url</span> / <span class="inline">--tcvdb-username</span> / <span class="inline">--tcvdb-database</span> / <span class="inline">--tcvdb-embedding-model</span>（密钥优先用 <span class="inline">--tcvdb-api-key-env TCVDB_API_KEY</span> 从环境变量读取，或用 <span class="inline">--tcvdb-api-key</span> 占位）；<span class="inline">--sqlite-path</span> 可选，默认取 data dir 下的 <span class="inline">vectors.db</span>。</td><td>迁移计划、collection 检查、manifest 草稿。</td><td>先备份 SQLite，确认 endpoint / token 只来自占位配置或安全环境。</td></tr>
...
<table class="t">
  ...
  <tr><td class="mono">migrate-sqlite-to-tcvdb --dry-run</td><td>Assess migration from local SQLite to Tencent VectorDB.</td><td><span class="inline">--plugin-data-dir</span> and <span class="inline">--openclaw-config-path</span> (required), plus the TCVDB connection flags <span class="inline">--tcvdb-url</span> / <span class="inline">--tcvdb-username</span> / <span class="inline">--tcvdb-database</span> / <span class="inline">--tcvdb-embedding-model</span> (prefer <span class="inline">--tcvdb-api-key-env TCVDB_API_KEY</span> to read the key from an env var, or <span class="inline">--tcvdb-api-key</span> as a placeholder); <span class="inline">--sqlite-path</span> is optional, defaulting to <span class="inline">vectors.db</span> under the data dir.</td><td>Migration plan, collection checks, manifest draft.</td><td>Back up SQLite first; confirm endpoint / token come only from placeholder config or secure environment.</td></tr>
