...
<div class="layers">
  <div class="layer"><div class="lt">Host</div><div class="ld">OpenClaw hooks/tools 或 Gateway/Hermes HTTP 调用，负责宿主生命周期与请求形态。</div></div>
  <div class="layer"><div class="lt">Adapters</div><div class="ld">把日志、路径、LLM runner、运行上下文翻译成 core 可用的统一接口。</div></div>
  <div class="layer hl"><div class="lt">TdaiCore</div><div class="ld">统一处理 recall、capture、memory search、conversation search 与 scheduler。</div></div>
</div>
...
<div class="layers">
  <div class="layer"><div class="lt">Host</div><div class="ld">OpenClaw hooks/tools or Gateway/Hermes HTTP calls own host lifecycle and request shape.</div></div>
  <div class="layer"><div class="lt">Adapters</div><div class="ld">Translate logging, paths, LLM runners, and runtime context into one interface the core can use.</div></div>
  <div class="layer hl"><div class="lt">TdaiCore</div><div class="ld">Handles recall, capture, memory search, conversation search, and the scheduler uniformly.</div></div>
</div>
